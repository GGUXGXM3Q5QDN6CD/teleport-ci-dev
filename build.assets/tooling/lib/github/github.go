...
type GitHub interface {
	...
	ListJobs(ctx context.Context, owner, repo, path, ref string, since time.Time) (map[int64]struct{}, error)
	TriggerDispatchEvent(ctx context.Context, owner, repo, path, ref string, inputs map[string]interface{}) (int64, error)
...
func NewGitHubWitToken(ctx context.Context, token string) GitHub {
