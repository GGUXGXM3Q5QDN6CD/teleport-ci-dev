...
func (f *fakeGitHub) ListJobs(ctx context.Context, owner, repo, path, ref string, since time.Time) (map[int64]struct{}, error) {
	return nil, trace.NotImplemented("Not required for test")
}

func (f *fakeGitHub) TriggerDispatchEvent(ctx context.Context, owner, repo, path, ref string, inputs map[string]interface{}) (int64, error) {
	return -1, trace.NotImplemented("Not required for test")
}
